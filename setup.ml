...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7861e0cd37ff2a7079bd6275a6709bc2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "OCaml bindings for Wlc (https://github.com/Cloudef/wlc)";
          description = None;
          categories = [];
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Wlc__prelude"; "Wlc__keysym"; "Wlc__wl"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Wlc";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "k\201{hse\156\153Pk\127\240\167V \029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
